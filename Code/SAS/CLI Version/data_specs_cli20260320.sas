...
%macro data_specs_cli(
    ...
    %let out_file = &doc_dir\data_specs_%sysfunc(compress(&ggg_parent,'_',kad))_%sysfunc(compress(&gg_parent,'_',kad))_%sysfunc(compress(&g_parent,'_',kad))_%sysfunc(today(),yymmddn8.).xlsx;
